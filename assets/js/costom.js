...
var markers = [
  {
    ...
    popupContent: '<img src="https://ychef.files.bbci.co.uk/976x549/p09h83yc.jpg"><h3>Vadodara</h3><p>Collection centre of Finished Board</p>'
  },
  {
    lngLat: [75.478192, 23.597970], // [longitude, latitude] of the marker position
    popupContent: '<img src="https://im.indiatimes.in/media/content/2019/Mar/global_recycling_day_1552985398_725x725.jpg"><h3> Madhya Pradesh</h3><p>Collection centre of Finished Board</p>'
  },

  {
    lngLat: [72.493950,24.110878], // [longitude, latitude] of the marker position
    popupContent: '<img src="https://im.indiatimes.in/media/content/2018/Apr/plastic_1523957599.jpg"><h3>Vadgam, Gujarat</h3><p>Collection centre of Finished Board</p>'
  },

  {
    lngLat: [74.516593,21.831092], // [longitude, latitude] of the marker position
    popupContent: '<img src="https://en-media.thebetterindia.com/uploads/2019/04/IMG_7020.jpg"><h3>Pati, Madhya Pradesh</h3><p>Collection centre of Finished Board</p>'
  },

  {
    lngLat: [74.832818, 20.867474], // [longitude, latitude] of the marker position
    popupContent: '<img src="https://indian-retailer.s3.ap-south-1.amazonaws.com/s3fs-public/article5615.jpg"><h3>Dhule , Maharashtra</h3><p>Collection centre of Finished Board</p>'
  },

  {
    lngLat: [73.843388, 19.920099], // [longitude, latitude] of the marker position
    popupContent: '<img src="https://images.yourstory.com/cs/5/571d59d0-2d6c-11e9-aa97-9329348d4c3e/Untitled_design-81559651782782.png"><h3>Nashik, Maharashtra</h3><p>Collection centre of Finished Board</p>'
  }
  ...
  map2.on('load', function() {
      ...
      fetch(apiUrl)
        ...
        .then(function(data) {
          ...
          //           }
          //         },
          //         // Add features for each destination point
          //         {
          //           type: 'Feature',
          //           properties: {},
          //           geometry: {
          //             type: 'Point',
          //             coordinates:[74.7749,20.9042]   // [73.789803,19.997454]
          //           }
          //         },
          //         {
          //           type: 'Feature',
          ...
          //           geometry: {
          //             type: 'Point',
          //             coordinates: [73.243896, 22.264793]
          //           }
          //         },
          ...
          //           geometry: {
          //             type: 'Point',
          //             coordinates: [74.173257, 21.975842]
          //           }
          //         },
          //         // Add more destination points as needed
          //       ]
